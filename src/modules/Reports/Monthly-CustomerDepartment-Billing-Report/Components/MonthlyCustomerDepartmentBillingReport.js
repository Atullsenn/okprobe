...
const MonthlyCustomerDepartmentBillingReport = () => {
    ...
    return (
        <>
            <div className="d-flex f-align-center f-justify-between mb-8">
                <Typography variant="h4">{t("MonthlyCustomer/DepartmentReport")}</Typography>
            </div>
...
export default MonthlyCustomerDepartmentBillingReport;
