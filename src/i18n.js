...
const resources = {
  en: {
    translation: {
      ...
      'sidebarPrintersManagement': 'Printer Management',
      ...
      'processcolorprinter': 'Color Printer',
      'processcolormfp': 'Color MFP',
      'processmonoprinter': 'Mono Printer',
      'processmonomfp': 'Mono MFP',
      'moreoptions': 'More Options',
      'Customer': 'Customer',
      'MonthlyCustomer/DepartmentReport': 'Monthly Customer/Department Billing Report',
      'MonthlyModelReport': 'Monthly Model Usage Report',
      'MonthlyDeviceReport': 'Monthly Device Billing Report',
      'black': 'Black',
      'cyan': 'Cyan',
      'magenta': 'Magenta',
      'yellow': 'Yellow',
      'under': 'Under',
      'RemaininAllConsumables': 'Remainin All Consumables',
      'sidebarConsumables': 'Consumables',
      'sidebarRemainingToner/Ink': 'Remaining TONER/INK',
      'sidebarRemainingAll': 'Remaining All',
      'MachineCount': 'Machine Count',
      'CurrentLevel': 'Current Level',
      'Lastcollecteddate': 'Last collected date',
      'Lastchangedate': 'Last change date',
      'reference': 'Reference',
      'ConsumableSerialNumber': 'Consumable Serial Number',
      'full': 'Full',
      'nearFull': 'Near Full',
      'Remaining': 'Remaining',
      'WasteTonerState': 'Waste Toner State',
      'License': 'License',
      'sidebarLicenseManagement': "License Management",
      'test': 'Test',
      ...
      'sidebarSystemLog': 'System Log',
      'sidebarServerConfiguration': 'Server Configuration',
      'Agent': 'Agent',
      'AgentList': 'Agent List',
      'Name': 'Name',
      'Version': 'Version',
      'StartDate': 'Start Date',
      'LastCollectDate': 'Last Collect Date',
      ...
      'FaultManageCycle': 'Fault Manage Cycle',
      'UsageManageCycle': 'Usage Manage Cycle',
      'ConsumableManageCycle': 'Consumable Manage Cycle',
      'DBBackupManageCycle': 'DB Backup Manage Cycle',
      'IndexRebuildManageCycle': 'Index Rebuild Manage Cycle',
      'server': 'Servers',
      'ServerSettings': 'Server Settings',
      'SMTPSettings': 'SMTP Settings',
      'SystemErrorNotificationSettings': 'System Error Notification Settings',
      ...
      'noofDevice': 'No of Devices',
      'FunctionsOptionsSubjects': 'Functions / Options Subjects',
      ...
      'printerToner': 'Toner',
      'printerInk': 'Ink',
      'printerBrowse': 'Browse',
      'supportPaperSize': 'Support Paper Size',
      'printerColour': 'Color',
      ...
      'processModelTable': 'Model Table',
      'processModelDetailInfo': 'Detail Info',
      ...
      'CustomerInfo-1': 'Customer Info-1',
      'CustomerInfo-2': 'Customer Info-2',
  ...
  ko: {
    translation: {
      ...
      'sidebarSummary': '요약',
      'sidebarPrinters': '프린터',
      'sidebarPrintersManagement': '프린터 관리',
      'sidebarCustomers': '고객',
      ...
      'modelname': '모델명',
      'processcolorprinter': '컬러 프린터',
      'processcolormfp': '컬러 복합기',
      'processmonoprinter': '흑백 프린터',
      'processmonomfp': '흑백 복합기',
      'moreoptions': '추가 옵션',
      'Customer': '고객사',
      'MonthlyCustomer/DepartmentReport': ' 월간 부서별 과금 보고서',
      'MonthlyModelReport': '월간 모델별 과금 보고서',
      'MonthlyDeviceReport': '월간 기기별 과금 보고서',
      'black': '검정',
      'cyan': '파랑',
      'magenta': '빨강',
      'yellow': '노랑',
      'under': '미만',
      'RemaininAllConsumables': '전체 보여 주는 거 1개 : All / 4색 포함',
      'sidebarConsumables': '소모품',
      'sidebarRemainingToner/Ink': '토너/잉크 잔량',
      'sidebarRemainingAll': '모든 소모품 잔량',
      'MachineCount': '총 페이지 수',
      'CurrentLevel': '잔량',
      'Lastcollecteddate': '수집시간',
      'Lastchangedate': '최근 교체일',
      'reference': '참고',
      'ConsumableSerialNumber': '소모품 시리얼 번호',
      'full': '가득참',
      'nearFull': '거의 참',
      'Remaining': '잔량',
      'WasteTonerState': '페토너 상태',
      'License': '라이선스',
      'sidebarLicenseManagement': "라이선스 관리",
      'test': '테스트',
      ...
      'DatabaseDisconnected': '데이터베이스 연결 끊김',
      'LicenseExpired': '라이선스 만료',
      'sidebarSystemLog': '시스템 로그',
      'sidebarServerConfiguration': '서버 구성',
      'Agent': '에이전트',
      'AgentList': '에이전트 목록',
      'Name': '이름',
      'Version': '버전',
      'StartDate': '시작일',
      'LastCollectDate': '최종 수집일',
      'Polling Interval (Minutes)': '수집 간격(분)',
      'Pause': '일시 중지',
      'Resume': '다시 사용',
      'Assignment': '할당',
      'Assigned Department': '부서 할당',
      'Action': '동작',
      'DepartmentSearch': '부서 검색',
      'SelectDepartment': '부서 선택',
      'DepartmentList': '부서 목록',
      'Pleaseselectadepartment': '부서를 선택하십시오.',
      'YouareSelected': '선택함',
      'EmailServer': '메일 서버 *',
      'ID': '아이디',
      'Password': '비밀번호',
      'Defaultsenderemail': '기본 발신자 주소 *',
      'SecureType': '암호화 방식 *',
      'PortNumber': '포트번호 *',
      'FaultManageCycle': '장애 관리 주기',
      'UsageManageCycle': '사용량 관리 주기',
      'ConsumableManageCycle': '소모품 관리 주기',
      'DBBackupManageCycle': 'DB 백업 관리 주기',
      'IndexRebuildManageCycle': 'DB Index Rebuild 관리 주기',
      'server': '서버',
      'ServerSettings': '서버 설정',
      'SMTPSettings': '메일 설정',
      'SystemErrorNotificationSettings': '에러 통지 설정',
      'sidebarContact': '문의',
      'settingsTitle': '설정',
      ...
      'dashboardCheck': '점검',
      'dashboardStatus': '상태',
      'CustomerDisplayName': '고객명',
      'noofDevice': '최대 장치',
      'FunctionsOptionsSubjects': '기능 / 옵션 사항',
      'ApplicationKey': '프로그램 키',
      'Are you sure': '확인하였습니까?',
      'createBtn': '생성',
      'activateBtn': '활성화',
      'downloadBtn': '다운로드',
      'importBtn': '가져오기',
      ...
      "processagent": '에이전트',
      'processSerialNumber': '시리얼',
      'processPrinterModel': '모델',
      'processIp': 'IP',
      'processHostName': '호스트명',
      'processRegisterPrinter': '프린터 등록',
      'processDepartmentName': '부서명',
      'processLocation': '위치',
      'processSelect': '선택',
      ...
      'processModelTable': '모델 관리',
      'processModelDetailInfo': '상세 정보',
      ...
      'ContractEnd': '계약 종료일',
      'Department': '부서',
      'CustomerInfo-1': '고객 정보 1',
      'CustomerInfo-2': '고객 정보 2',
      ...
      'summarycancel': '취소',
      'summaryFrom': '계약기간 시작',
      'startofContract': '계약 시작일',
      'contractTerminal': '계약 종료일',
      'summaryTo': '계약기간 종료',
